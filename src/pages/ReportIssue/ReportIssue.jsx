    ...
    return (
        <div className='max-w-5/6 mx-auto py-5'>
            ...
            <div className="text-center mb-8">
                <h2 className='text-3xl font-bold lg:text-4xl mb-2'>Report Issue</h2>
                <p className='text-gray-700 dark:text-white/75'>Report an issue to the system</p>
            ...
            <div className="mt-8">
                <form onSubmit={handleSubmit(handleFormSubmit)} className="space-y-6 ng-untouched ng-pristine ng-valid px-5">
                    <div className="space-y-4">
                        ...
                        <fieldset className='flex justify-between items-center gap-5'>
                            <fieldset className='w-full fieldset flex flex-col justify-between gap-2'>
                                <label htmlFor="username" className='label text-gray-700 dark:text-gray-300'>Reporter Name</label>
                                <input
                                    className='w-full rounded-sm input bg-gray-100 dark:bg-gray-700 text-gray-900 dark:text-white border-gray-300 dark:border-gray-600'
                                    type="text"
                                    id="username"
                            ...
                            <fieldset className='w-full fieldset flex flex-col justify-between gap-2'>
                                <label htmlFor="email" className='label text-gray-700 dark:text-gray-300'>Email</label>
                                <input
                                    type="email"
                                    id="email"
                                    {...register("reporterEmail")}
                                    defaultValue={user?.email}
                                    className="input w-full rounded-sm bg-gray-100 dark:bg-gray-700 text-gray-900 dark:text-white border-gray-300 dark:border-gray-600"
                                    readOnly
                                />
                            </fieldset>
                        </fieldset>
                        ...
                        <fieldset className='flex justify-between items-center gap-5'>
                            <fieldset className='w-full mx-auto'>
                                <select
                                    ...
                                    className="select w-full rounded-sm bg-gray-100 dark:bg-gray-700 text-gray-900 dark:text-white border-gray-300 dark:border-gray-600"
                                >
                                    <option disabled={true}>Pick Category</option>
                                    {categories.map((category, index) => <option key={index}>{category}</option>)}
                                </select>
                            ...
                            <fieldset className='w-full mx-auto'>
                                <legend className="block mb-2 text-sm text-gray-700 dark:text-gray-300">Urgency Level</legend>
                                <div className="flex items-center space-x-4">
                                    <label className="inline-flex items-center">
                                        <input type="radio" {...register("priority")} value="Normal" className="form-radio" />
                                        <span className="ml-2 text-gray-700 dark:text-gray-300">Normal</span>
                                    </label>
                                    <label className="inline-flex items-center">
                                        <input type="radio" {...register("priority")} value="Medium" className="form-radio" />
                                        <span className="ml-2 text-gray-700 dark:text-gray-300">Medium</span>
                                    </label>
                                    <label className="inline-flex items-center">
                                        <input type="radio" {...register("priority")} disabled value="High" className="form-radio" />
                                        <span className="ml-2 text-gray-700 dark:text-gray-300">
                                            High <span className="text-xs">(Boast for High)</span>
                                        </span>
                                    </label>
                                </div>
                            </fieldset>
                        ...
                        <fieldset>
                            <label htmlFor="issueDescription" className="block mb-2 text-sm text-gray-700 dark:text-gray-300">
                                Issue Description
                            </label>
                            <textarea
                                {...register("description")}
                                id="issueDescription"
                                placeholder="Describe the issue in detail"
                                className="w-full px-3 py-2 border rounded-md border-gray-300 dark:border-gray-600 focus:outline-blue-500 bg-gray-100 dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500"
                                rows="5"
                                data-temp-mail-org="0"
                            ></textarea>
                        </fieldset>
                        ...
                        <div>
                            <label htmlFor="issueImage" className="block mb-2 text-sm font-medium text-gray-700 dark:text-gray-300">
                                Upload Image (optional)
                            </label>
                            <input
                                type="file"
                                {...register('image')}
                                accept="image/*"
                                className="block w-full text-sm text-gray-500 dark:text-gray-400 file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-semibold file:bg-blue-50 dark:file:bg-blue-900 file:text-blue-700 dark:file:text-blue-300 hover:file:bg-blue-100 dark:hover:file:bg-blue-800 bg-gray-100 dark:bg-gray-700 border border-dashed border-blue-300 dark:border-blue-600 rounded-md cursor-pointer focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-blue-400 p-1"
                            />
                        ...
                        <fieldset className='flex justify-between items-center gap-4'>
                            <fieldset className='fieldset w-full'>
                                <legend className="fieldset-legend text-gray-700 dark:text-gray-300">Select Your Region</legend>
                                <select
                                    {...register("region")}
                            ...
                            <fieldset className="fieldset w-full">
                                <legend className="fieldset-legend text-gray-700 dark:text-gray-300">Select Your District</legend>
                                <select
                                    {...register('district')}
                            ...
                            <fieldset className="fieldset w-full">
                                <legend className="fieldset-legend text-gray-700 dark:text-gray-300">Select Upzila</legend>
                                <select
                                    {...register('upzila')}
                                    defaultValue="Pick an upzila"
                                    className="select w-full rounded-sm bg-gray-100 dark:bg-gray-700 text-gray-900 dark:text-white border-gray-300 dark:border-gray-600"
                                >
                                    <option disabled={true}>Pick an upzila</option>
                                    {upByDistrict(up).map((d, i) => <option key={i} value={d}>{d}</option>)}
                        ...
                        <fieldset className="fieldset">
                            <label htmlFor="location" className="block mb-2 text-sm text-gray-700 dark:text-gray-300">
                                Location
                            </label>
                            <input
                                type="text"
                    ...
                    <div>
                        <button
                            type="submit"
                            className="bg-blue-500 dark:bg-blue-600 w-full rounded-md py-3 text-white hover:bg-blue-700 dark:hover:bg-blue-700"
                        >
                            Submit Issue
                        </button>
                    </div>
