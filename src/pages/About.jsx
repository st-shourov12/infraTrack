...
const About = () => {
  return (
    <div className="min-h-screen  dark:bg-gray-800 pt-24 py-12 px-4">
      {/* bg-linear-to-br from-blue-50 via-indigo-50 to-purple-50 */}
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          <h1 className="text-5xl font-bold text-gray-800 dark:text-white mb-4">About InfraTrack</h1>
          <p className="text-xl text-gray-600 dark:text-white/75 max-w-3xl mx-auto">
            Building Smarter, Safer Cities Together
          </p>
        </div>

        <div className="bg-white/80 dark:bg-gray-600 backdrop-blur-lg rounded-2xl shadow-xl p-10 mb-12">
          <p className="text-lg text-gray-700 dark:text-white/90 leading-relaxed text-center max-w-4xl mx-auto">
        ...
        <section className="mb-16">
          <h2 className="text-3xl font-semibold text-center text-gray-800 dark:text-white mb-8">Common Issues We Help Fix</h2>
          <p className="text-center text-gray-600 dark:text-white/75 mb-8">Citizens often encounter frustrating problems that impact daily life:</p>
        ...
        <section className="grid md:grid-cols-2 gap-12 items-center mb-16">
          <div>
            ...
            <ul className="space-y-4 text-lg text-gray-700 dark:text-white/75">
        ...
        <section className="bg-white/80 dark:bg-gray-600 backdrop-blur-lg rounded-2xl shadow-xl p-10">
          <h2 className="text-3xl font-semibold text-center text-gray-800 dark:text-white mb-8">Key Benefits</h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600 dark:text-white/75">Track issue status publicly for accountability and trust.</p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600 dark:text-white/75">Prioritized workflows reduce delays.</p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600 dark:text-white/75">Analyze trends to prevent future problems.</p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600 dark:text-white/75">Better resource allocation for proactive maintenance.</p>
            </div>
          </div>
        </section>
