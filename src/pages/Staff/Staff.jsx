...
const Staff = () => {
    ...
    const handleFormSubmit = async (data) => {
        const {
            fullName, email, phone, nid, department, qualification,
            experience, region, district, upzila, password, profileImage
        } = data;
                ...
                <form onSubmit={handleSubmit(handleFormSubmit)} className="space-y-6 ng-untouched ng-pristine ng-valid px-5">
                    ...
                    <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
                        ...
                        <div className="space-y-4">
                            ...
                            <fieldset className='flex flex-col md:flex-row justify-between items-center gap-5'>
                                <fieldset className='w-full fieldset flex flex-col justify-between gap-2'>
                                    <label htmlFor="fullName" className='label text-gray-700 dark:text-gray-300'>
                                        Full Name <span className="text-red-500">*</span>
                                    </label>
                                    <input
                                        className='w-full input bg-gray-100 dark:bg-gray-700 text-gray-900 dark:text-white border-gray-300 dark:border-gray-600'
                                        type="text"
                                        id="fullName"
                                        {...register("fullName", { required: "Full name is required" })}
                                        defaultValue={user?.displayName}
                                ...
                                <fieldset className='w-full fieldset flex flex-col justify-between gap-2'>
                                    ...
                                    <input
                                        ...
                                        {...register("email", { required: "Email is required" })}
                                        defaultValue={user?.email}
                                        className="input w-full bg-gray-100 dark:bg-gray-700 text-gray-900 dark:text-white border-gray-300 dark:border-gray-600"
                                    />
                                </fieldset>
                            </fieldset>
                            ...
                            <fieldset className='flex flex-col md:flex-row justify-between items-center gap-5'>
                                <fieldset className='w-full fieldset flex flex-col justify-between gap-2'>
                                    <label htmlFor="phone" className='label text-gray-700 dark:text-gray-300'>
                                        Phone Number <span className="text-red-500">*</span>
                                    </label>
                                    <input
                                        className='w-full input bg-gray-100 dark:bg-gray-700 text-gray-900 dark:text-white border-gray-300 dark:border-gray-600'
                                ...
                                <fieldset className='w-full fieldset flex flex-col justify-between gap-2'>
                                    <label htmlFor="nid" className='label text-gray-700 dark:text-gray-300'>
                                        National ID Number <span className="text-red-500">*</span>
                                    </label>
                                    <input
                                        type="text"
                                        ...
                                        {...register("nid", {
                                            required: "NID is required",
                                            minLength: { value: 5, message: "NID must be at least 5 digits" }
                                        })}
                                        className="input w-full bg-gray-100 dark:bg-gray-700 text-gray-900 dark:text-white border-gray-300 dark:border-gray-600"
                                        placeholder="Enter your NID number"
                                    />
                            ...
                            <fieldset className='flex flex-col md:flex-row justify-between items-center gap-5'>
                                <fieldset className='w-full fieldset flex flex-col justify-between gap-2'>
                                    ...
                                    <input
                                        ...
                                        placeholder="Enter password"
                                        className="input w-full input-bordered bg-gray-100 dark:bg-gray-700 text-gray-900 dark:text-white border-gray-300 dark:border-gray-600"
                                    />
                                    {errors.password && <span className="text-error text-sm">{errors.password.message}</span>}
                                </fieldset>

                                <div className='w-full fieldset flex flex-col justify-between gap-2'>
                                    <label htmlFor="profileImage" className="block mb-2 text-sm font-medium text-gray-700 dark:text-gray-300">
                                        Profile Photo <span className="text-red-500">*</span>
                                    </label>
                                    <input
                                        type="file"
                                        {...register('profileImage')}
                                        accept="image/*"
                                        className="block w-full text-sm text-gray-500 dark:text-gray-400 file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-semibold file:bg-blue-50 dark:file:bg-blue-900 file:text-blue-700 dark:file:text-blue-300 hover:file:bg-blue-100 dark:hover:file:bg-blue-800 bg-gray-100 dark:bg-gray-700 border border-dashed border-blue-300 dark:border-blue-600 rounded-md cursor-pointer focus:outline-none focus:ring-2 focus:ring-blue-400 p-1"
                                    />
                                    <p className="mt-1 text-xs text-gray-400 dark:text-gray-500">PNG, JPG or JPEG (max 5MB)</p>
                                </div>
                            </fieldset>
                        </div>
                    </div>
                    ...
                    {/* Professional Information Section */}
                    <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
                        <h3 className="text-xl font-semibold mb-4 text-gray-800 dark:text-white">Professional Information</h3>
                        ...
                        <div className="space-y-4">
                            <fieldset className='flex flex-col md:flex-row justify-between items-center gap-5'>
                                <fieldset className='w-full mx-auto'>
                                    ...
                                    <select
                                        {...register("department", { required: "Department is required" })}
                                        defaultValue="Pick Department"
                                        className="select w-full bg-gray-100 dark:bg-gray-700 text-gray-900 dark:text-white border-gray-300 dark:border-gray-600"
                                    >
                                        <option disabled={true}>Pick Department</option>
                                        {departments.map((dept, index) => <option key={index}>{dept}</option>)}
                                    </select>
                            ...
                            <fieldset className='w-full fieldset flex flex-col justify-between gap-2'>
                                <label htmlFor="experience" className='label text-gray-700 dark:text-gray-300'>
                                    Years of Experience <span className="text-red-500">*</span>
                                </label>
                                <input
                                    className='w-full input bg-gray-100 dark:bg-gray-700 text-gray-900 dark:text-white border-gray-300 dark:border-gray-600'
                    ...
                    {/* Preferred Work Location Section */}
                    <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
                        <h3 className="text-xl font-semibold mb-4 text-gray-800 dark:text-white">Preferred Work Location</h3>
                    ...
                    <div>
                        <button
                            type="submit"
                            className="bg-blue-500 dark:bg-blue-600 w-full rounded-md py-3 text-white hover:bg-blue-700 dark:hover:bg-blue-700 font-semibold transition-colors duration-200"
                        >
                            Submit Application
                        </button>
                    </div>
