...
const MyIssues = () => {
    ...
    const getStatusColor = (status) => {
        switch (status) {
            ...
            case 'closed': return 'bg-red-100 text-red-800 dark:bg-red-900/40 dark:text-red-300';
    ...
    return (
        <div className="min-h-screen bg-gray-50 dark:bg-gray-900 p-6">
            <div className="max-w-7xl mx-auto">
                ...
                {/* Header */}
                <div className="mb-8">
                    <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">My Issues</h2>
                    <p className="text-gray-600 dark:text-gray-400">Manage and track your reported issues</p>
                </div>
                ...
                <div className="space-y-4">
                    {filteredIssues.length === 0 ? (
                        ...
                        filteredIssues.map((issue) => (
                            <div key={issue?._id} className="bg-white dark:bg-gray-800 rounded-lg shadow-sm hover:shadow-md transition-shadow">
                                <div className="p-6">
                                    <div className="flex flex-col md:flex-row gap-6">
                                        ...
                                        <div className="grow">
                                            ...
                                            <div className="grid grid-cols-2 gap-4 mb-4 text-sm">
                                                <div>
                                                    ...
                                                    <span className="ml-2 text-gray-900 dark:text-gray-200">{issue?.upzila}, {issue?.district}</span>
                                                </div>
                                                <div>
                                                    <span className="text-gray-500 dark:text-gray-400">Region:</span>
                                                    <span className="ml-2 text-gray-900 dark:text-gray-200">{issue?.region}</span>
                                                </div>
                                            </div>
                ...
                {showEditModal && editingIssue && (
                    <div className="fixed inset-0 bg-black/60 dark:bg-black/70 flex items-center justify-center p-4 z-50">
                        <div className="bg-white dark:bg-gray-800 rounded-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto">
                            ...
                            <div className="p-6 space-y-4">
                                <UpdateIssue refetch={refetch} editingIssue={editingIssue} setShowEditModal={setShowEditModal} />
                            </div>
                        </div>
                    </div>
                )}
